  ...
  return (
    <div className=" w-32 mt-10">
      <menu className="flex items-center justify-center gap-4 my-4">
        <li>
          <button className="p-2 bg-neutral-400 font-semibold text-slate-200 rounded-md  ">
            Cancel
          </button>
        </li>
        <li>
          <button className="p-2 bg-neutral-400 font-semibold text-slate-200 rounded-md hover:bg-lime-400">
            Save
          </button>
        </li>
      </menu>
